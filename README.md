...
<!-- Animated text -->
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com/?color=FF00FF&size=35&center=true&width=290&lines=EMAIL;SIGNATURE"/>
</div>

<h2 align="right">1.1. INTRODUCTION 📰</h2>

Este repositório contém a minha assinatura de e-mail personalizada, pronta para uso em diferentes sistemas de e-mail. A assinatura foi projetada para fornecer informações essenciais sobre mim de forma profissional e atraente.

<h2 align="right">1.2. DESCRIPTION 📝</h2>

A assinatura foi projetada em HTML com CSS inline para garantir que seja exibida corretamente em uma variedade de dispositivos e clientes de e-mail.
